...
function buildSystemPrompt(ctx = {}) {
  ...
  const facts = knowledge.salonFacts();
  ...
  parts.push('НАЛИЧИЕ АВТОМОБИЛЕЙ: клиенты часто спрашивают, есть ли машина в наличии. Отвечай строго по полю «НАЛИЧИЕ» в карточке: «в наличии» — можно приехать и посмотреть; «в пути» — машина на складе в другом филиале, в течение 1–2 дней можем переместить её в наш автосалон; если наличие не указано — не обещай, скажи, что менеджер уточнит.');
